...
// Precomputed CRC-8 lookup table (Polynomial 0x07, Initial value 0x00)
...
// Compute CRC-8 using the lookup table
...
int main() {
    ...
    uint8_t result = crc8(data, sizeof(data), 0x00);
    printf("CRC-8 result: 0x%02X\n", result);
    return 0;
}
*/
